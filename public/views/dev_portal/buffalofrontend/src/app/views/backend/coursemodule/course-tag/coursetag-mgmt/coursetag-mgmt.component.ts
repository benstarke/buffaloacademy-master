...
@Component({
  ...
  templateUrl: './coursetag-mgmt.component.html',
  styleUrl: './coursetag-mgmt.component.css'
})
export class CoursetagMgmtComponent implements OnInit {
