...
import { AboutinfoComponent } from '../../../../../frontends/about/aboutinfo/aboutinfo.component';
...
export class AboutLayoutComponent implements OnInit {
  ...
  navigate(path: string | undefined) {
    if (path) {
      this.router.navigate([`/admin-buffalo/system-information-management/other-pages/dashboard-about/${path}`]);
    } else {
      this.router.navigate(['/admin-buffalo/system-information-management/other-pages/dashboard-about']);
    }
  }
