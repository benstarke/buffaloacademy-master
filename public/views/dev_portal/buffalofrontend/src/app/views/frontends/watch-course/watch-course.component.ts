...
export class WatchCourseComponent implements OnInit, OnDestroy {
  course!: CoursesInfo;
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.subscribe(params => {
      ...
      // You can use these parameters to fetch and display the curriculum and lessons.
  ...
  goBackToCourses(): void {
    this.router.navigate(['/app-student/main-dashboard/all_courses'], { 
      queryParams: { courseTitle: this.courseTitle, courseId: this.courseId } 
    });
  }
